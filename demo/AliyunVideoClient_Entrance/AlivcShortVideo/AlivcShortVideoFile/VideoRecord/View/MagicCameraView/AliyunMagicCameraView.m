...
- (AliyunRecordBeautyView *)rightView{
    if (!_rightView) {
        _rightView = [[AliyunRecordBeautyView alloc] initWithFrame:CGRectMake(0, ScreenHeight-200, ScreenWidth, 200)  titleArray:@[@"人脸贴纸",@"贴纸",@"animoji",@"哈哈镜",@"背景分割",@"动漫滤镜",@"手势识别",@"AR面具",@"音乐滤镜",@"表情识别"] imageArray:@[@"shortVideo_gifPicture",@"",@"",@"",@"",@"",@"",@"",@"",@""]];
