...
- (void)setupParamData {
    ...
    cellModel0.title = @"帧率";
    cellModel0.placeHolder = @"建议20-30，默认30";
    ...
    cellModel1.placeHolder = @"建议1-300，默认250";
